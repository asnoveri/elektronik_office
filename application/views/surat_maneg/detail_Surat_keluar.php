            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane container fade" id="action_srt_msk_user">
                        <div class="row">
                            <div class="col-sm-6">
                                <form  method="POST" action="<?= base_url()?>Managemen_Surat/add_suratkeluar_diteruskan/<?=$srt_keluarbyId->id_surat_keluar?>">
                                    <input type="hidden" class="form-control" name="id_surat_keluar" value="<?= $srt_keluarbyId->id_surat_keluar?>">
                                    <div class="form-group mt-3">
                                            <label for="">Teruskan Pengajuan Disposisi Surat Keluar</label>
                                            <select  class="custom-select custom-select " name="di_teruskan_ke_srt_klr">
