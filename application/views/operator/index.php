   ...
   <div class="container-fluid">
           ...
           <div class="card-body">
             <div class="row">
               <div class="col-sm-12 mb-2">
                 <button type="button" class="btn btn-sm btn-info mt-3" data-toggle="modal" data-target="#modal_cetak_absen">
     ...
     <div class="modal" id="modal_cetak_absen">
       <div class="modal-dialog modal-sm">
         <div class=" modal-content">
           <div class="modal-header">
             <h5 class="modal-title" id="label_modal_absensi">Cetak Absensi Bulanan</h5>
             <button type="button" class="close" data-dismiss="modal">&times;</button>
           </div>
           <div class="modal-body">
             <form action="<?= base_url() ?>Operator/cet_AbsenBulan" method="post" target="_blank">
               <div class="form-group">
                 <input type="text" hidden name="pegawai" value="<?= $this->session->userdata('id') ?>">
                 <input type="text" readonly class="form-control mb-3" name="tanggal" id="tgl_absen_cetak" placeholder="Pilih Tanggal">
