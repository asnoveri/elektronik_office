<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <?php  } ?>
            <h5 class="m-0 font-weight-bold text-secondary">Laporan LookBook Pegawai</h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="tbl_lookbook_all" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Nama</th>
